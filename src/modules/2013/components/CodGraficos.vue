  ...
  <v-row justify="space-around">
    ...
    <div class="color" style="
      ...
      <div style="margin-left: 100px">
        <div v-for="(data, index) in chartData" :key="index" style="margin-top: 150px; white-space: nowrap">
          <div>
            <div v-for="(value, dataIndex) in data.values" :key="dataIndex" style="
                ...
                position: relative;
              ">
              <div :style="`background-color: ${value.color}; height: ${value.height * 6.40
...
export default {
  ...
  mounted() {
    ...
    var porcentaje = [3.72, 56.89, 1.31, 3.27, 6.79, 22.85, 1.23, 3.94];
