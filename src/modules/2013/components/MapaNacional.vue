          ...
          <v-row no-gutters>
            ...
            <v-col cols="12" md="3">
              <div class="align2">
                <!--Boton Busqueda-->
                <v-fab-transition>
                  <v-btn active-class="deep-purple " color="#12A2C2" dark absolute left fab
                ...
                <v-fab-transition>
                  <v-btn active-class="deep-purple " color="#12A2C2" dark absolute right fab
                    style="width: fit-content; padding: 5px;" @click.stop=limpiar()>
                    Limpiar filtros
    ...
    <v-navigation-drawer v-model="drawer" absolute temporary width="350px" color="#12A2C2">
      <v-row class="filtro">
        <v-col cols="12">
          ...
          <div>
            <v-select v-model="type" :items="['1']" disabled dense outlined hide-details class="ma-5"></v-select>
...
import CodMapa from '@/modules/2013/components/CodMapa';
import TCandidatoV1 from '@/modules/2013/components/TarjetaCandidato';
...
export default {
  ...
  data() {
    const provincia = require('@/modules/2013/assets/Informacion/provincias_cantones.json');
    const candidato = require('@/modules/2013/assets/Informacion/candidatosV2.json');
    return {
      /*Variables de Select */
      select: '',
      select2: '',
      ...
      tituloMapa: '0',
      titulo: 'Resultados Nacionales 2013'
  ...
  methods: {
    ...
    primeraV() {
      ...
      this.titulo = 'Resultados Nacionales 2013'
