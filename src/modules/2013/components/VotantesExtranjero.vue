...
<script>
import InfoGeneral from '@/modules/2013/components/InfoGeneral.vue';
import CodGraficose from '@/modules/2013/components/CodGraficose.vue';
import CodTablas from '@/modules/2013/components/CodTablas.vue';
import MapaExtranjero from '@/modules/2013/components/MapaExtranjero.vue';

export default {
  name: "VotantesExtranjeros2013",
  data: () => {
  ...
  components: { CodGraficose, CodTablas, MapaExtranjero, InfoGeneral }
