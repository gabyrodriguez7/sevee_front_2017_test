      ...
      <v-card flat color="c-Inicio" width="100%">
        <v-window touchless v-model="onboarding">
          ...
          <v-window-item :value="2">
            <div class="size">
              <div class="d-flex justify-center mb-6 size" v-if="numero_vuelta == 0">
                <CodTablas v-bind:zona="''" v-bind:vuelta=1></CodTablas>
              </div>
              <div class="d-flex justify-center mb-6 size" v-else>
...
import MapaNacional from '@/modules/2009/components/MapaNacional.vue';
import CodGraficos from '@/modules/2009/components/CodGraficos.vue';
