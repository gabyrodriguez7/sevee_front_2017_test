...
import CodMapa from '@/modules/2009/components/CodMapa';
import TCandidatoV1 from '@/modules/2009/components/TarjetaCandidato';
...
export default {
  ...
  data() {
    ...
    const provincia = require('@/modules/2009/assets/Informacion/provincias_cantones.json');
    const candidato = require('@/modules/2009/assets/Informacion/candidatosV2.json');
    return {
      /*Variables de Select */
      select: '',
      select2: '',
      ...
      tituloMapa: '0',
      titulo: 'Resultados Nacionales 2009'
  ...
  methods: {
    ...
    primeraV() {
      ...
      this.titulo = 'Resultados Nacionales 2009'
