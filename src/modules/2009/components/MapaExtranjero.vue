                  ...
                  <v-card elevation="25">
                    <v-card-text class="map_titulo">
                      <div class="d-flex justify-center white--text"> <span>
                          Resultados Internacionales 2009
                        </span></div>
                    </v-card-text>
                  </v-card>
                </v-row>
...
import CodMapaExtranjero from '@/modules/2009/components/CodMapaExtranjero.vue';
import TCandidatoV1 from '@/modules/2009/components/TarjetaCandidato';


export default {
  name: "MapaExtranjero2009",
  ...
  data() {
    ...
    return {
      ...
      tituloMapa: '0',
      titulo: 'RESULTADOS INTERNACIONALES 2009'

    }
  },
  components: { TCandidatoV1, CodMapaExtranjero },
  methods: {
