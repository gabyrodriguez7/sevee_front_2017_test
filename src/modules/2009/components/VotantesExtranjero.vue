...
<script>
import InfoGeneral from '@/modules/2009/components/InfoGeneral.vue';
import CodGraficose from '@/modules/2009/components/CodGraficose.vue';
import CodTablas from '@/modules/2009/components/CodTablas.vue';
import MapaExtranjero from '@/modules/2009/components/MapaExtranjero.vue';

export default {
  name: "VotantesExtranjeros2009",
  data: () => {
