...
const muestraVotosAusentes = async (vuelta) => {
    const data = axios.get(`http://192.168.5.109:8080/API/Sevee/V1/actas/ausentes/${vuelta}`).then(r => r.data)
    console.log(data)
    return data
}
...
const busquedaIzquierdaFachada = async (vuelta, provincia, canton) => {
    const data = axios.get(`http://192.168.5.109:8080/API/Sevee/V1/votos/filtroIzquierda/${vuelta}/${provincia}/${canton}`).then(r => r.data);
    console.log(data);
    return data;
}
...
const totalGeneroFachada = async (vuelta, genero) => {
    const data = axios.get(`http://192.168.5.109:8080/API/Sevee/V1/votos/votosGenero/${vuelta}/${genero}`).then(r => r.data);
    console.log(data);
    return data;
}
...
const totalSufragioFachada = async (vuelta) => {
    const data = axios.get(`http://192.168.5.109:8080/API/Sevee/V1/votos/votosValidos/${vuelta}`).then(r => r.data);
    console.log(data);
    return data;
}
...
const muestraTablaGeneralesFachada = async (vuelta) => {
    const data = axios.get(`http://192.168.5.109:8080/API/Sevee/V1/votos/votosListaCandidatoGeneroGeneral/${vuelta}`).then(r => r.data)
    return data
}
*/