...
<script>
const desserts = [
    { porcentaje: 'Menor porcentaje de votos', p1: '#bdd7e7', p2: '#fdbe85', },
    { porcentaje: 'Porcentaje de votos bajo', p1: '#6baed6', p2: '#fd8d3c', },
    { porcentaje: 'Porcentaje de votos medio', p1: '#3182bd', p2: '#e6550d', },
    { porcentaje: 'Mayor porcentaje de votos', p1: '#08519c', p2: '#a63603', },
