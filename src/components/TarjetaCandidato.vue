...
const candidato = [
    ...
    { partido: 2, nombre: 'ANDRÉS ARAUZ', url: require('@/assets/Candidatos/150px/2.png'), color: '#EF8A62', nombrePartido: '1-5 Unión Por La Esperanza', json: '2' },
    { partido: 3, nombre: 'YAKU PÉREZ', url: require('@/assets/Candidatos/150px/3.png'), color: '#54278f', nombrePartido: 'Movimiento De Unidad Plurinacional Pachakutik', json: '3' },
    { partido: 4, nombre: 'XAVIER HERVAS', url: require('@/assets/Candidatos/150px/4.png'), color: '#fcbd00', nombrePartido: 'Partido Izquierda Democrática', json: '4' },
    { partido: 5, nombre: 'PEDRO JOSÉ FREILE', url: require('@/assets/Candidatos/150px/5.png'), color: '#41b6c4', nombrePartido: 'Movimiento Amigo', json: '5' },
    { partido: 6, nombre: 'ISIDRO ROMERO', url: require('@/assets/Candidatos/150px/6.png'), color: '#d81b60', nombrePartido: 'Partido Político Avanza', json: '6' },
    { partido: 7, nombre: 'LUCIO GUTIÉRREZ', url: require('@/assets/Candidatos/150px/7.png'), color: '#cb4335', nombrePartido: 'Partido Sociedad Patriótica 21 De Enero', json: '7' },
    { partido: 8, nombre: 'GERSON ALMEIDA', url: require('@/assets/Candidatos/150px/8.png'), color: '#808080', nombrePartido: 'Movimiento Ecuatoriano Unido', json: '8' },
    { partido: 9, nombre: 'XIMENA PEÑA', url: require('@/assets/Candidatos/150px/9.png'), color: '#239b56', nombrePartido: 'Movimiento Alianza País', json: '9' },
    { partido: 10, nombre: 'GUILLERMO CELI', url: require('@/assets/Candidatos/150px/10.png'), color: '#553d2a', nombrePartido: 'Partido Político Sociedad Unida Más Acción', json: '10' },
    { partido: 11, nombre: 'JUAN F. VELASCO', url: require('@/assets/Candidatos/150px/11.png'), color: '#d4ac0d', nombrePartido: 'Movimiento Construye', json: '11' },
    { partido: 12, nombre: 'CESAR MONTUFAR', url: require('@/assets/Candidatos/150px/12.png'), color: '#006691', nombrePartido: 'Alianza Honestidad', json: '12' },
    { partido: 13, nombre: 'GUSTAVO LARREA', url: require('@/assets/Candidatos/150px/13.png'), color: '#fa8072', nombrePartido: 'Movimiento Democracia Sí', json: '13' },
    { partido: 14, nombre: 'CARLOS SAGNAY', url: require('@/assets/Candidatos/150px/14.png'), color: '#765900', nombrePartido: 'Partido Fuerza Ec', json: '14' },
    { partido: 15, nombre: 'GIOVANNY ANDRADE', url: require('@/assets/Candidatos/150px/15.png'), color: '#00ffff', nombrePartido: 'Unión Ecuatoriana', json: '15' },
    { partido: 16, nombre: 'PAÚL CARRASCO', url: require('@/assets/Candidatos/150px/16.png'), color: '#cb35a3', nombrePartido: 'Movimiento Nacional Podemos', json: '16' },
]
var partidos = [
