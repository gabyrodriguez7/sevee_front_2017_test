<template>
  <v-row justify="space-around">
    ...
    <div style="overflow-x: auto; width: 100%; position: absolute; left: 0px;">
...
export default {
  ...
  mounted() {
    ...
    var porcentaje = [17.43, 44.03, 18.86, 8.86, 1.66, 2.20, 0.84, 1.49, 1.33, 0.62, 0.51, 0.71, 0.35, 0.36, 0.25, 0.21]
